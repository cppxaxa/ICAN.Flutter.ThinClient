...
public final class Feature {
  ...
  public Feature(
    ...
    this.inputIds = inputIds.stream().mapToInt(i->i).toArray();
    this.inputMask = inputMask.stream().mapToInt(i->i).toArray();
    this.segmentIds = segmentIds.stream().mapToInt(i->i).toArray();
